...
module gameLogic {
    ...
    export function isWinner(r:any, c:any, board:any){
    ...
    export function getStartRC(row:any, col:any, slope:any){
    	if(slope == 0){
    		return [row, 0];
    	}
    	if(slope  == 2){
    ...
    export function getPossibleMoves(board:any, row:any, col:any, turnIndexBeforeMove:any){
        var possibleMoves:any = [];
        //slope == 1;
    ...
    export function createMove(board:any, brow:any, bcol:any, arow:any, acol:any, turnIndexBeforeMove:any){
    	//var boardAfterMove:any = copyObject(board);
			var boardAfterMove:any = angular.copy(board);
        boardAfterMove[arow][acol] = turnIndexBeforeMove === 0 ? 'W' : 'R';
        boardAfterMove[brow][bcol] = '';
				console.log("create move apo to game logic");
    ...
    export function getCheckNum(board:any, startR:any, startC:any, slope:any){
        var checkNum = 0;
        if(slope === 0){
            for(var i=0; i<8; i++){
    ...
    export function isMoveLegal(board:any, brow:any, bcol:any, arow:any, acol:any, turnIndexBeforeMove:any) {
    ...
    export function isMoveOk(params:any){
    	//alert("test");
			console.log("mpika sto ismoveok");
